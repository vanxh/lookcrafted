									...
									>
										...
										<div className="p-6">
											...
											<div className="mb-6 flex justify-center">
												<div className="relative">
													<div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-100 to-purple-100 shadow-lg ring-4 ring-white transition-shadow group-hover:shadow-xl dark:from-blue-900/30 dark:to-purple-900/30 dark:ring-gray-800">
														<UserRound className="h-10 w-10 text-blue-600 dark:text-blue-400" />
													</div>
													{headshot.status === "completed" && (
